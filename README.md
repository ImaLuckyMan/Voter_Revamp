...
<h1 id="3">How this imporoves the current system </h2>
...
<h1 id="7">Installation</h2>
No installation is required. Site will be published via WWW. You will only require an updated web browser.
